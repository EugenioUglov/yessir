class CommandInputField {
    constructor() {
        ...
        this.#commandInputContainer = document.getElementsByClassName("command-input-container")[0];
    ...
    setCommandInputFiled(commandObjects) {
        ...
        that.#commandInput.classList.add(commandContainerClassName);
        ...
        handleInnerShadowsOfElemOnScroll(that.#commandInput, true);
        ...
        that.#commandInput.addEventListener('click', () => {
        ...
        that.#commandInput.addEventListener('input', () => {
            const commandInputWords = getWordsOfText(getNormalizedTextOfTextarea(that.#commandInput.value));
    ...
    showCommandInput() {
        this.#commandInputContainer.style.display = 'block';
    }

    hideCommandInput() {
        this.#commandInputContainer.style.display = 'none';
    }
}